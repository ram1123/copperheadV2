...
time python plotter/compare_inclusiveDY_DYvbfFilter.py      --dirs1 /work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean/Run2_NanoV15_forVBFChannel_Apr29_2026_jetUnc/stage1_output/2017/f1_0/dyTo2L_M-50_aMCatNLO      --dirs2 /work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean/Run2_NanoV15_May26_2026_dyVbfFilterValidation/stage1_output/2017/f1_0/dy_VBF_filter      --nbins  55 --xmin 110  --xmax 150     --output compareDY_incl_vs_VBFfilter55bins_110_150_2017UL.pdf

time python plotter/compare_inclusiveDY_DYvbfFilter.py      --dirs1 /work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean/Run2_NanoV15_forVBFChannel_Apr29_2026_jetUnc/stage1_output/2016postVFP/f1_0/dyTo2L_M-50_aMCatNLO      --dirs2 /work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean/Run2_NanoV15_May26_2026_dyVbfFilterValidation/stage1_output/2016postVFP/f1_0/dy_VBF_filter      --nbins  55 --xmin 110  --xmax 150     --output compareDY_incl_vs_VBFfilter55bins_110_150_2016postVFPUL.pdf


time python plotter/compare_inclusiveDY_DYvbfFilter.py      --dirs1 /work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean/Run2_NanoV15_forVBFChannel_Apr29_2026_jetUnc/stage1_output/2016preVFP/f1_0/dyTo2L_M-50_aMCatNLO      --dirs2 /work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean/Run2_NanoV15_May26_2026_dyVbfFilterValidation/stage1_output/2016preVFP/f1_0/dy_VBF_filter      --nbins  55 --xmin 110  --xmax 150     --output compareDY_incl_vs_VBFfilter55bins_110_150_2016preVFPUL.pdf


time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv15_run2.yaml -v 15 -l  Run2_NanoV15_May26_2026_dyVbfFilterValidation -y "2016postVFP,2016preVFP" -m 0 -k)
...
sh produce_postFitPlot.sh /work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean/Run2_NanoV12_forVBFChannel_Apr29_2026_jetUnc/stage3_datacards_May10_2026/score_Run2_NanoV12_forVBFChannel_Apr29_2026_jetUnc/  2017
```

# 04 May 2026

when running run2 nanoV12, replace `config/switchs.yaml` contents with `configs/parameters/apr14_switches/switches-run2V12.yaml` and when running nanoV15, replace contents with `configs/parameters/apr14_switches/switches-run2V15.yaml`.
...
## VBF significance
```bash
cd /work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean/Run2_NanoV12_forVBFChannel_Apr29_2026/stage3_datacards_May04_2026
...
## plotting fake and real jets
```bash
python plotter/plot_real_fake_jets_stack.py -i /work/projects/hmm/shar1172/hmm_ntuples/copperheadV1clean/Run3_nanoAODv12_FilterJetsHorn25GeV_Apr09_tightPassLepVeto_NoJER_v2/stage1_output/2022postEE/compacted/dyTo2L_M-50_incl/0/part000.parquet -o Run3_nanoAODv12_FilterJetsHorn25GeV_Apr09_tightPassLepVeto_NoJER_v2/2022postEE/dyTo2L_M-50_incl --normalize


python plotter/plot_real_fake_jets_stack.py -i /work/projects/hmm/shar1172/hmm_ntuples/copperheadV1clean/Run3_nanoAODv12_FilterJetsHorn25GeV_Apr09_tightPassLepVeto_NoJER_v2/stage1_output/2022postEE/compacted/vbf_powheg_dipole/0/part0.parquet -o Run3_nanoAODv12_FilterJetsHorn25GeV_Apr09_tightPassLepVeto_NoJER_v2/2022postEE/vbf_powheg_dipole --normalize


python plotter/plot_real_fake_jets_stack.py -i /work/projects/hmm/shar1172/hmm_ntuples/copperheadV1clean/Run3_nanoAODv12_FilterJetsHorn25GeV_Apr09_tightPassLepVeto_NoJER_v2/stage1_output/2022postEE/compacted/ggh_powhegPS/0/part0.parquet -o Run3_nanoAODv12_FilterJetsHorn25GeV_Apr09_tightPassLepVeto_NoJER_v2/2022postEE/ggh_powhegPS --normalize
```


# 27 April 2026
```bash
sh stage2_sh.sh all all
```


# 24 April 2026
## zpt re-wgt for nanov12 

```bash
bash stage1_loop_Improved.sh  -l  Run2_NanoV12_Apr24_2026_JetHornPuId_JerStrat3_UpdatedBtagWp_wQgl -y 2016preVFP -m "zpt_fit0" -n 0

bash stage1_loop_Improved.sh  -l  Run2_NanoV12_Apr24_2026_JetHornPuId_JerStrat3_UpdatedBtagWp_wQgl -y 2016preVFP -m "zpt_fit1" -n 0

bash stage1_loop_Improved.sh  -l  Run2_NanoV12_Apr24_2026_JetHornPuId_JerStrat3_UpdatedBtagWp_wQgl -y 2016postVFP -m "zpt_fit0" -n 0

bash stage1_loop_Improved.sh  -l  Run2_NanoV12_Apr24_2026_JetHornPuId_JerStrat3_UpdatedBtagWp_wQgl -y 2016postVFP -m "zpt_fit1" -n 0
```


## zpt re-wgt for nanov15

```bash
bash stage1_loop_Improved.sh  -l  Run2_NanoV15_Apr14_2026_UpdatedBtagWp -y 2016preVFP -m "zpt_fit0" -n 0

bash stage1_loop_Improved.sh  -l  Run2_NanoV15_Apr14_2026_UpdatedBtagWp -y 2016preVFP -m "zpt_fit1" -n 0

bash stage1_loop_Improved.sh  -l  Run2_NanoV15_Apr14_2026_UpdatedBtagWp -y 2016postVFP -m "zpt_fit0" -n 0

bash stage1_loop_Improved.sh  -l  Run2_NanoV15_Apr14_2026_UpdatedBtagWp -y 2016postVFP -m "zpt_fit1" -n 0
```
...
## zpt re-wgt for nanov15
```bash
bash stage1_loop_Improved.sh  -l Run2_NanoV15_Apr14_2026_UpdatedBtagWp -y 2017 -m "zpt_fit0" -n 0

bash stage1_loop_Improved.sh -l Run2_NanoV15_Apr14_2026_UpdatedBtagWp -y 2017 -m "zpt_fit1" -n 0

bash stage1_loop_Improved.sh -v 12 -l Run2_NanoV15_Apr14_2026_UpdatedBtagWp -y 2017  -m "zpt_fit2" -n 0
```

## zpt re-wgt for nanov12 
```bash
bash stage1_loop_Improved.sh  -l Run2_NanoV12_Apr14_2026_JetHornPuId_JerStrat3_UpdatedBtagWp -y 2017 -m "zpt_fit0" -n 0

bash stage1_loop_Improved.sh -l Run2_NanoV12_Apr14_2026_JetHornPuId_JerStrat3_UpdatedBtagWp -y 2017 -m "zpt_fit1" -n 0

bash stage1_loop_Improved.sh -v 12 -l Run2_NanoV12_Apr14_2026_JetHornPuId_JerStrat3_UpdatedBtagWp -y 2017  -m "zpt_fit2" -n 0
```
...
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv12_run2.yaml -v 12 -l  Run2_NanoV15_Apr09_2026_JetHornPuId_JerStrat3_UpdatedBtagWp -y "2017" -m 1 -k)
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv12_run2.yaml -v 12 -l  Run2_NanoV15_Apr09_2026_JetHornPuId_JerStrat3_UpdatedBtagWp -y "2017" -m 1 -k)
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv12_run2.yaml -v 12 -l  Run2_NanoV15_Apr09_2026_JetHornPuId_JerStrat3_UpdatedBtagWp -y "2017" -m 1 -k)
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv12_run2.yaml -v 12 -l  Run2_NanoV15_Apr09_2026_JetHornPuId_JerStrat3_UpdatedBtagWp -y "2017" -m compact -k)



time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv15_run2.yaml -v 15 -l  Run2_NanoV15_Apr09_2026_UpdatedBtagWp -y "2017" -m 1 -k)
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv15_run2.yaml -v 15 -l  Run2_NanoV15_Apr09_2026_UpdatedBtagWp -y "2017" -m 1 -k)
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv15_run2.yaml -v 15 -l  Run2_NanoV15_Apr09_2026_UpdatedBtagWp -y "2017" -m 1 -k)
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv15_run2.yaml -v 15 -l  Run2_NanoV15_Apr09_2026_UpdatedBtagWp -y "2017" -m compact -k)
...
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv12_run3.yaml -v 12 -l Run3_nanoAODv12_23Jan_JVMFilterJets -y "run3" -m dnn_pre -k)
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv12_run3.yaml -v 12 -l Run3_nanoAODv12_23Jan_JVMFilterJets -y "run3" -m dnn_train -k)
