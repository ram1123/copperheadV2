...
for year in years:
    ...
    for njet in jet_multiplicities:
        ...
        for target_nbins in nbins:
            ...
            if njet == 0: min_y, max_y = 0.6, 1.7
            if njet == 1: min_y, max_y = 0.8, 1.5
            if njet == 2: min_y, max_y = 0.8, 1.5
            hist_SF.SetMinimum(min_y)  # Set the lower bound of the Y-axis
            hist_SF.SetMaximum(max_y)  # Set the upper bound of the Y-axis
            hist_SF.Draw()
            ...
            print("Number of parameters in the fit:", num_params)
