...
if __name__ == "__main__":
    ...
    for njet in [2]:
        ...
        hist_data = ROOT.TH1F("hist_data", "Histogram with Variable Bin Widths", len(binning) - 1, binning_array)
        hist_dy = ROOT.TH1F("hist_dy", "Histogram with Variable Bin Widths", len(binning) - 1, binning_array)
        ...
        canvas = ROOT.TCanvas("canvas", "Histogram with Variable Bin Widths", 800, 600)
        hist_SF.Draw()
