...
# Configuration
# -----------------------------------------------------
# label="Run2_NanoV15_Apr14_2026_UpdatedBtagWp"
label="Run2_NanoV15_forVBFChannel_Apr29_2026_jetUnc"
base_path="/work/projects/hmm/yun79/hmm_ntuples/copperheadV1clean"
stage2_load_path="${base_path}/${label}/stage1_output"

category="ggh"


# model_name="Run2_NanoV15_Apr14_2026_UpdatedBtagWp"
# model_name="Run2_NanoV12_Apr14_2026_JetHornPuId_JerStrat3_UpdatedBtagWp"
# model_name="Run2_NanoV15_Apr27_2026"
model_name="Run2_NanoV15_May24_2026"
...
# all_years=(all)
all_years=(2016preVFP 2016postVFP 2017 2018 all)
...
if [[ "${step}" == "7" || "${step}" == "dcall" || "${step}" == "all" ]]; then
    for year_i in "${years[@]}"; do
        ...
        # stage3_label="${label}_X_${model_name}_${label_tag}_sumExpRemoved"
        # stage3_label="${label}_X_${model_name}_${label_tag}_BWZReduxRemoved"
        # stage3_label="${label}_X_${model_name}_${label_tag}_FEWZxBernRemoved"
        stage3_label="${label}_X_${model_name}_${label_tag}"
        save_path="output/bdt_${model_name}_${model_trainYear}"
        
        # stage2_save_path="/work/projects/hmm/shar1172/hmm_ntuples/copperheadV1clean/Run3_nanoAODv12_FilterJetsHorn30GeV_Feb23_tightPassLepVeto_NoJER_AddVars_v2/Run3_10March_020Trials_ggh_AllYear/stage2_output"
