...
AAA_REDIRECTORS = [
    # "root://xcache.cms.rcac.purdue.edu/", # 1.        # 1
    # "root://xcache.cms.rcac.purdue.edu/", # 2
    "root://eos.cms.rcac.purdue.edu/",  # 3                # 2
    "root://cms-xrd-global.cern.ch/",  # 4                  # 3
    "root://xrootd-cms.infn.it/",  # 5                         # 4
    "root://cmsxrootd.fnal.gov/",  # 6                        # 5
