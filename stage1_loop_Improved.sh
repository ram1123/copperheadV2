...
for year in "${years[@]}"; do
    ...
    if [[ "$mode" == "0" ]]; then
        ...
        command1="python data/zpt_rewgt/fitting/do_f_test.py --run_label ${label} --year ${year} --nbins ${nbin} --njet ${njet} --outAppend \"May09\" --debug"
        command4="python data/zpt_rewgt/fitting/get_polyFit.py -l ${label} -y ${year} --nbins ${nbin} --njet ${njet} --outAppend \"May09\""
