...
```bash
time(bash stage1_loop_Improved.sh -c configs/datasets/dataset_nanoAODv12_run3.yaml -v 12 -l Run3_nanoAODv12_12Nov -p HPScan_03Sep_17bins -y "2022postEE" -m 0 -k -d 1)
```
